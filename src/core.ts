...
export interface Store { open: Record<string, TabRecord>; closed: Record<string, TabRecord>; usage: Record<string, UrlUsage>; collections: Collection[]; undo: UndoEntry[]; retention: { elapsedMs: number; activeSince?: number }; preferences: Preferences }
